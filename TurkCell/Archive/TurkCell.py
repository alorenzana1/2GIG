...
class simpleapp_tk(Tkinter.Tk):
    def __init__(self,parent=None):
        ...
        if(self.csv_file == ""):
            ...
            file_name = "2GIG-3GTC90-A_"+file_name+".txt"
    ...
    def FetchData(self):
        ...
        csv_column[2] = "2GIG-3GTC90-A"                    # SimType
        ...
        csv_column[8] = self.atDevice.Get_ModuleSN()       # ModuleSN
...
if __name__ == "__main__":
    ...
    app.title('IMEI writer')
    app.iconbitmap('2gig.ico')
    app.mainloop()
